...
public class BigDecimalUtil {
    ...
    /**
     * 提供精确的加法运算，scale 表示需要精确到小数点以后几位。
     * 返回两个参数数学加和，以字符串格式返回
     */
    ...
    /**
     * 提供精确的减法运算，scale 表示需要精确到小数点以后几位。
     * 返回两个参数的差
     */
    ...
    /**
     * 提供精确的乘法运算，scale 表示需要精确到小数点以后几位。
     * 返回两个参数的积
     */
    ...
    /**
     * 提供（相对）精确的除法运算，当发生除不尽的情况时，精确到小数点以后10位
    ...
    /**
     * 提供（相对）精确的除法运算。当发生除不尽的情况时，由scale参数指定精度
     * 以后的数字四舍五入，舍入模式采用用户指定舍入模式
     * 参数：
     * scale      表示需要精确到小数点以后几位
     * round_mode 表示用户指定的舍入模式
     * 返回两个参数的商
     */
